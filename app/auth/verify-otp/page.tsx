...
// Note: do not auto-login after verification; redirect to login page instead
        ...
        <div className="w-full max-w-md rounded-2xl border border-[#e9e3d8] bg-white p-8 shadow-md">
          ...
          <form className="space-y-4" onSubmit={handleVerify}>
            ...
            <button
              ...
              className="w-full bg-[#1C1C1C] text-white rounded-lg px-4 py-2 text-sm disabled:opacity-70"
            >
          ...
          <button
            ...
            className="w-full mt-3 border border-[#ddd6c9] rounded-lg px-4 py-2 text-sm"
          >
