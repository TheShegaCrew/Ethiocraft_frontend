...
import { ShoppingCart, Menu, X, UserCircle, User, LogOut } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      >
        <div className="container mx-auto px-4 py-4 relative z-10">
          <div className="flex items-center justify-between relative">
            ...
            <Link
              href="/"
              className={`flex items-center gap-2 font-bold text-xl transition-colors font-logo ${textColor}`}
            >
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <Link href="/cart">
                  <Button
                    variant="ghost"
                    size="icon"
                    className={`relative mr-5 transition-colors ${textColor} hover:bg-[#FAFAF9]/20`}
                  >
                ...
                {isLoggedIn ? (
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        ...
                        className={`font-aeonik transition-colors ${textColor} uppercase tracking-widest hover:bg-transparent ml-2`}
                      >
                  ...
                  <Link href="/auth/login">
                    <Button
                      variant="outline"
                      className={`font-aeonik transition-colors border-current ${textColor} uppercase tracking-widest bg-transparent hover:bg-[#FAFAF9]/20 ml-2`}
                    >
                      sign in
                    </Button>
                  </Link>
                ...
                <div className="flex flex-col gap-4 mt-4 px-2">
                  ...
                  {isLoggedIn ? (
                    <>
                      ...
                      <Button
                        variant="ghost"
                        className="justify-start text-xs font-bold uppercase tracking-widest text-destructive hover:text-destructive px-0"
                        onClick={() => {
                          logout();
                          setIsMenuOpen(false);
                        }}
